// Inline feather-style icons — no external dependency.
const P = {
  ...
  board: <g><rect x="3" y="3" width="5" height="18" rx="1" /><rect x="9.5" y="3" width="5" height="13" rx="1" /><rect x="16" y="3" width="5" height="9" rx="1" /></g>,
  list: <g><line x1="8" y1="6" x2="21" y2="6" /><line x1="8" y1="12" x2="21" y2="12" /><line x1="8" y1="18" x2="21" y2="18" /><line x1="3.5" y1="6" x2="3.51" y2="6" /><line x1="3.5" y1="12" x2="3.51" y2="12" /><line x1="3.5" y1="18" x2="3.51" y2="18" /></g>,
  columns: <g><rect x="3" y="4.5" width="7.5" height="15" rx="1.5" /><rect x="13.5" y="4.5" width="7.5" height="15" rx="1.5" /></g>,
...
export default function Icon({ name, size = 18, className }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">{P[name] || null}</svg>
  )
}
