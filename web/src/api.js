...
export const addBacklog = (b) => apiSend('/api/backlog', 'POST', b)
export const setBacklogStatus = (id, status) => apiSend(`/api/backlog/${encodeURIComponent(id)}/status`, 'POST', { status })
export const deleteBacklog = (id) => apiSend(`/api/backlog/${encodeURIComponent(id)}`, 'DELETE', {})
...
export const getHouseTemplate = () => apiGet('/api/marketing/template')
export const putHouseTemplate = (html) => apiSend('/api/marketing/template', 'PUT', { html })
...
export const sendBlast = (id, limit = 0) => apiSend(`/api/blasts/${encodeURIComponent(id)}/send`, 'POST', { limit })
